...
public class Combat : MonoBehaviour
{
    ...
    public void StartCombat()
    {
        ...
        CardUIController.instance.AttDeckCard(combatents[0]);
        CardUIController.instance.AttDeckCard(combatents[1]);
    ...
    public void EndTurn()
    {
        ActionController.instance.AddToQueue(new EndTurnAction());
        ActionController.instance.AddToQueue(new AdvanceCombatAction(1));
    }
